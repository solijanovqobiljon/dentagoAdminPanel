...
const Sidebar = ({ isSidebarOpen, setIsSidebarOpen }) => {
    ...
    const navItems = [
        ...
        // --- KLINIKA BO'LIMI (GROUP) ---
        {
            ...
            name: "klinika",
            subItems: [
                { label: "Xodimlar", route: "/klinika/xodimlar" },
                { label: "Xizmatlar(Card)", route: "/klinika/xizmatlar-card" },
                { label: "Xizmatlar kategoriyalari", route: "/klinika/xizmatlar-kategoriyalari" },
                { label: "Xizmatlar", route: "/klinika/xizmatlar" },
                { label: "Davolashlar", route: "/klinika/davolashlar" },
                { label: "Davolashni rejalashtirish", route: "/klinika/davolashni-rejalashtirish" },
                { label: "Bemorlar", route: "/klinika/bemorlar" },
                { label: "Qarzdor Davolashlar", route: "/klinika/qarzdor-davolashlar" },
                { label: "Ma'lumotlar", route: "/klinika/malumotlar" },
            ]
        },
